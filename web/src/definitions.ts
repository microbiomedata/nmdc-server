const Definitions = {
  ...
  dataDoiProvider: 'This is a placeholder hint for dataDoiProvider and should be replaced',
  dataDoiValue: 'This is a placeholder hint for dataDoiValue and should be replaced',
