...
export default defineComponent({
  ...
  setup() {
    ...
    const doiRequiredRules = () => [(v: string) => {
      ...
      if (!/^doi:10.\d{2,9}.*$/.test(v)) {
        return 'Doi must be in the correct format.';
      }
          ...
          <v-card class="d-flex flex-column grow pa-4 mb-4">
            <div class="d-flex">
              ...
              <v-select
                ...
                clearable
                class="mb-2 mr-3"
                :error-messages="multiOmicsForm.awardDois[i].provider ? undefined : ['A provider must be selected.']"
              >
                <template #message="{ message }">
                  <span v-html="message" />
                </template>
