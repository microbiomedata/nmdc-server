...
const minimumPermissionLevel: SubmissionEditorRole = "metadata_contributor"
const isEditable = computed(() => getSubmissionUneditableReason(minimumPermissionLevel) === undefined);
...
const saveRecord = () => saveCurrentEdits(props.id);
    ...
    watch(() => saveCurrentEditsRequest.count.value, () => {
...
<template>
  ...
  >
    <SubmissionUneditableBanner :minimum-permission-level="minimumPermissionLevel" />
    <v-alert
    ...
    >
      ...
      <div class="d-flex flex-column px-2 pb-2 pt-2">
        <div class="d-flex align-center">
          ...
          <span
            v-if="saveCurrentEditsRequest.loading.value"
            class="text-center"
          >
            <v-progress-circular
              color="primary"
