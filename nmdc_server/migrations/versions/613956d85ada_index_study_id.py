...
def upgrade():
    ...
    op.create_index(op.f('ix_omics_processing_study_id'), 'omics_processing', ['study_id'], unique=False)
    op.create_index(op.f('ix_study_id'), 'study', ['id'], unique=False)
    op.create_unique_constraint(op.f('uq_submission_role_submission_id'), 'submission_role', ['submission_id', 'user_orcid'])
