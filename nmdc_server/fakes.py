...
class MetagenomeAssemblyFactory(PipelineStepBase):
    ...
    scaffolds: int = Faker("pyfloat")
    contigs: int = Faker("pyfloat")
    scaf_bp: int = Faker("pyfloat")
    contig_bp: int = Faker("pyfloat")
    scaf_n50: int = Faker("pyfloat")
    scaf_l50: int = Faker("pyfloat")
    ctg_n50: int = Faker("pyfloat")
    ctg_l50: int = Faker("pyfloat")
    scaf_n90: int = Faker("pyfloat")
    scaf_l90: int = Faker("pyfloat")
    ctg_n90: int = Faker("pyfloat")
    ctg_l90: int = Faker("pyfloat")
    scaf_max: int = Faker("pyfloat")
    ctg_max: int = Faker("pyfloat")
    scaf_n_gt50k: int = Faker("pyfloat")
    scaf_l_gt50k: int = Faker("pyfloat")
    scaf_pct_gt50k: int = Faker("pyfloat")
    num_input_reads: int = Faker("pyfloat")
    num_aligned_reads: int = Faker("pyfloat")
